...
//           className="bg-gray-500 hover:bg-gray-600 text-white font-semibold justify-end px-6 py-2 rounded-full shadow-sm transition"
//         >
//           ← Back
//         </button>
//         <div>
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      >
        ...
        <button
          type="button"
          onClick={handleGoBack}
          className="bg-green-800 hover:bg-green-600 text-white font-medium px-2 py-1 rounded-full shadow-sm transition"
        >
          ←
        </button>
      </div>
